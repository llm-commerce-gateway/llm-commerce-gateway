/**
 * @commercegateway/commerce-gateway - Well-Known Federation Routes
 *
 ...
 * import { createWellKnownRoutes } from '@commercegateway/commerce-gateway/federation';
 *
 * const app = new Hono();
 *
 ...
 * ```typescript
 * import { Hono } from 'hono';
 * import { addFederationRoutes } from '@commercegateway/commerce-gateway/federation';
 *
 * const app = new Hono();
 *
