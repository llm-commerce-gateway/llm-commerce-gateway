/**
 * @commercegateway/commerce-gateway - Federation JWT Authentication
 *
 ...
 *
 * ⚠️ PREFER: Use `generateKeyPairDev()` from `@commercegateway/commerce-gateway/federation/auth/dev`
