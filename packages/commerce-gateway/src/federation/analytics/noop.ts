/**
 * @commercegateway/commerce-gateway - No-op Analytics Sink
 *
 ...
 * @example
 * ```typescript
 * import { FederationHub, NoopAnalyticsSink } from '@commercegateway/commerce-gateway/federation';
 *
 ...
 * @example
 * ```typescript
 * import { ConsoleAnalyticsSink } from '@commercegateway/commerce-gateway/federation';
 *
 * const hub = new FederationHub({
 *   registry: { type: 'memory' },
