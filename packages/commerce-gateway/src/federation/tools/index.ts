/**
 * @commercegateway/commerce-gateway - Federation Tools Module
 *
 ...
 * @example
 * ```typescript
 * import { registerFederationTools, MemoryMerchantRegistry, GatewayClient, IntentParser } from '@commercegateway/commerce-gateway/federation';
 *
