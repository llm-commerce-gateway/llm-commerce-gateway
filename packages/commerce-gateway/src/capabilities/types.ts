/**
 * @commercegateway/commerce-gateway - Gateway Capabilities Schema
 *
 ...
 * @example
 * ```typescript
 * import type { GatewayCapabilities, CapabilityProvider } from '@commercegateway/commerce-gateway';
 *
...
export interface GatewayCapabilities {
  ...
  /**
   * Version of the @commercegateway/commerce-gateway package.
 ...
 * @example
 * ```typescript
 * import type { CapabilityProvider, GatewayCapabilities } from '@commercegateway/commerce-gateway';
 *
