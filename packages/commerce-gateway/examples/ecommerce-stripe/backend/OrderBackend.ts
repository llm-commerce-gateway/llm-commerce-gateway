...
import type { OrderBackend, Order, Cart, ShippingAddress, PaymentInfo } from '@commercegateway/commerce-gateway/backends';
...
declare module '@commercegateway/commerce-gateway/backends' {
  interface Order {
