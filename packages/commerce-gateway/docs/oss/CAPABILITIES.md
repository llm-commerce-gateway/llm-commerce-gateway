...
> **Applies to**: `@commercegateway/commerce-gateway` v1.1.0+
...
import type { MerchantRegistry } from '@commercegateway/commerce-gateway/federation';
...
```typescript
import { mergeCapabilities } from '@commercegateway/commerce-gateway/capabilities';
...
interface GatewayCapabilities {
  ...
  /**
   * Package version of @commercegateway/commerce-gateway.
   */
...
```typescript
import { DEFAULT_CAPABILITIES } from '@commercegateway/commerce-gateway/capabilities';
...
```typescript
import { OSS_CAPABILITIES } from '@commercegateway/commerce-gateway/capabilities';
...
```typescript
import { hasCapabilities } from '@commercegateway/commerce-gateway/capabilities';
...
```typescript
import { isValidCapabilities } from '@commercegateway/commerce-gateway/capabilities';
...
The OSS version of `@commercegateway/commerce-gateway` is explicitly designed for single-tenant deployments:
...
```typescript
import { OSS_TENANT_CONTEXT } from '@commercegateway/commerce-gateway/extensions';
...
### Exports from `@commercegateway/commerce-gateway/capabilities`
