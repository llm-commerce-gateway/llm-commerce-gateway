...
**OSS Behavior**:
```typescript
import { createOSSCapabilityProvider } from '@commercegateway/commerce-gateway/cloud';
...
**Cloud Behavior**:
```typescript
import { createCloudCapabilityProvider } from '@commercegateway/commerce-gateway/cloud';
...
**Main package** (`@commercegateway/commerce-gateway`):
- ✅ Core gateway
...
**Subpath exports**:
- `@commercegateway/commerce-gateway/federation` - Full federation module
- `@commercegateway/commerce-gateway/federation/providers` - Cloud providers (requires API key)
- `@commercegateway/commerce-gateway/cloud` - Cloud capability modules
