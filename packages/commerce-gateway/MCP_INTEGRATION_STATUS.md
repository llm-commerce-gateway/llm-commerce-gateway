...
### Status: ✅ Implemented
- **Package**: `@commercegateway/registry-mcp`
...
1. **Query Parsing**: Uses `parseShopQuery()` from `@commercegateway/commerce-gateway/registry`
...
- The Gateway MCP Server factory is part of the main `@commercegateway/commerce-gateway` package
