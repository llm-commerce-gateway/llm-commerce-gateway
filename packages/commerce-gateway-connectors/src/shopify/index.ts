...
import type {
  ...
  Address,
  PaymentInfo,
} from '@betterdata/llm-gateway/backends/interfaces';
...
class ShopifyProductBackend implements ProductBackend {
  ...
  async getProductDetails(productId: string): Promise<Product | null> {
    // TODO: Implement Shopify product details fetch
    // Use GraphQL query:
    // query {
    //   product(id: $productId) {
    //     id, title, description, handle, images, variants, metafields, ...
    //   }
    // }
    
    throw new Error('Shopify product details not yet implemented. Coming soon!');
  }
  ...
  async checkInventory(
    ...
    // TODO: Implement Shopify inventory checking
    // Use GraphQL query:
    // query {
    //   productVariants(first: 250, query: "product_id:$productId") {
    //     edges {
    //       node {
    //         id, inventoryQuantity, availableForSale, ...
    //       }
    //     }
    //   }
    // }
    
    throw new Error('Shopify inventory check not yet implemented. Coming soon!');
  }
  ...
  async getRecommendations(
    ...
    // TODO: Implement Shopify recommendations
    // Can use:
    // - Collection-based recommendations
    // - Product tags
    // - Metafields for custom logic
    
    throw new Error('Shopify recommendations not yet implemented. Coming soon!');
  }
}
...
class ShopifyCartBackend implements CartBackend {
  ...
  async clearCart(cartId: string): Promise<Cart> {
    ...
    // Return updated cart
    return this.getCart(cartId) || cart;
  }
